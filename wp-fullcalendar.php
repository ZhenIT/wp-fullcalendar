...
class WP_FullCalendar{
	...
	public static function enqueue_scripts(){
	    ...
	    if( empty($wpfc_scripts_limit) || in_array($obj_id, explode(',',$wpfc_scripts_limit)) ){
		    //Scripts
            wp_enqueue_script('momnet-js', plugins_url('includes/js/lib/moment.min.js',__FILE__));
            wp_enqueue_script('wp-fullcalendar', plugins_url('includes/js/fullcalendar'.$min.'.js',__FILE__), array('jquery', 'jquery-ui-core','jquery-ui-widget','jquery-ui-position', 'jquery-ui-selectmenu'), WPFC_VERSION); //jQuery will load as dependency
            wp_enqueue_script('scheduler-js', plugins_url('includes/js/lib/scheduler'.$min.'.js',__FILE__));
            WP_FullCalendar::localize_script();
		    //Styles
		    wp_enqueue_style('wp-fullcalendar', plugins_url('includes/css/fullcalendar.css',__FILE__), array(), WPFC_VERSION);
           // wp_enqueue_style('wp-fullcalendar', plugins_url('includes/css/fullcalendar.print.css',__FILE__), array(), WPFC_VERSION);
            wp_enqueue_style('scheduler-css', plugins_url('includes/css/scheduler'.$min.'.css',__FILE__), array(), WPFC_VERSION);
	...
	public static function footer_js(){
		...
		<script type='text/javascript'>
		<?php
        if (file_exists(STYLESHEETPATH . '/wp-fullcalendar-inline-js.php')) {
            include (STYLESHEETPATH . '/wp-fullcalendar-inline-js.php');
        } elseif (file_exists(TEMPLATEPATH . '/wp-fullcalendar-inline-js.php')) {
            include (TEMPLATEPATH . '/wp-fullcalendar-inline-js.php');
        } else {
